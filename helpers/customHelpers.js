...
module.exports = {
    ...
    paginate: function (options) {
        ...
        if (options.hash.current === 1) {
            ...
            output += `<li class="page-item"><a href="${prefix}page=1" class="page-link">First</a></li>`;
        }
        ...
        for (; i <= Number(options.hash.current) + 4 && i <= Number(options.hash.pages); i++) {
            if (i === options.hash.current) {
                ...
                output += `<li class="page-item"><a href="${prefix}page=${i}" class="page-link">${i}</a></li>`;
            }
        ...
        if (options.hash.current === options.hash.pages) {
            ...
            output += `<li class="page-item"><a href="${prefix}page=${options.hash.pages}" class="page-link">Last</a></li>`;
        }
